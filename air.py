...
def init_db():
    ...
    # جدول کلمات کلیدی بروزرسانی شده برای پشتیبانی از رسانه
    cursor.execute("""
...
# گام اول کلمه کلیدی: دریافت متن کلمه کلیدی
...
# گام دوم کلمه کلیدی: دریافت محتوا (متن یا رسانه)
